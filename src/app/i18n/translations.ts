...
export const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  he: {
    ...
    'teamPanel.invite.send': 'צור הזמנה',
    'teamPanel.invite.sent': 'ההזמנה נוצרה — העתיקו את הקישור ושילחו אותו',
    'teamPanel.invite.hint': 'לא נשלח מייל אוטומטית. צרו הזמנה והעתיקו את קישור ההצטרפות.',
  ...
  en: {
    ...
    'teamPanel.invite.send': 'Create invite',
    'teamPanel.invite.sent': 'Invite created — copy the link and share it',
    'teamPanel.invite.hint':
      'No email is sent automatically. Create the invite, then copy its join link.',
